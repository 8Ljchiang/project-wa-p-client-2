...
import { ISession, IUser, DataTypes } from '../../core/types/data-type-definitions';
...
export default class SessionManagement extends Component<ISessionManagementProps, ISessionManagementState> {
	...
	componentDidMount() {
		...
		const allUsers = autoGenerateMockData<IUser>(DataTypes.User, appConfig.itemGenerationCount);
